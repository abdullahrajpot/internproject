          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {services.map((service, index) => (
              ...
              >
                ...
                <span className="absolute top-0 left-0 h-full w-1 bg-gradient-to-b from-transparent via-orange-400 to-transparent animate-glowLine pointer-events-none" />

                {/* Animated glow line - right */}
                <span className="absolute top-0 right-0 h-full w-1 bg-gradient-to-b from-transparent via-orange-400 to-transparent animate-glowLine pointer-events-none" />
