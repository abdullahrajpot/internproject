    ...
    <div className="relative text-white">
      <div className="relative min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col-reverse sm:flex-row items-center justify-between min-h-screen px-4 sm:px-10">
          ...
          {/* Hero Text */}
          <div
            className={`w-full sm:w-1/2 text-center sm:text-right max-w-xl transition-all duration-700 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'
              }`}
          >
      ...
      <section className="relative text-white py-20 px-6 sm:px-12 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <Link to='/internship' className="inline-block bg-orange-600 hover:bg-orange-700 text-white font-medium px-6 py-3 rounded-full shadow-md transition-transform transform hover:scale-105"          >
            Join the Platform →
          </Link>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <div className="space-y-4 mb-16">
            {faqs.map((faq, index) => (
              <div
                key={index}
                className={`relative bg-[#1a1a1a] border border-gray-800/30 rounded-2xl overflow-hidden transition-all duration-500 hover:border-gray-700/50 hover:shadow-2xl transform hover:-translate-y-1 ${openFAQ === index
              ...
              >
                ...
                >
                  <div className="flex items-center gap-4 flex-1">
                    <div
                      className={`min-w-[3rem] min-h-[3rem] rounded-xl flex items-center justify-center text-xl transition-all duration-300 transform group-hover:scale-105 ${openFAQ === index
                    ...
                    <h3
                      className={`text-lg sm:text-xl font-semibold transition-colors duration-300 ${openFAQ === index
                        ? 'text-orange-400'
                  ...
                  <div className="flex items-center gap-2 ml-4">
                    <span
                      className={`text-sm font-medium ${openFAQ === index
                        ? 'text-orange-400'
                    ...
                    <div
                      className={`w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 transform ${openFAQ === index
                        ? 'bg-orange-500 rotate-180 shadow-lg shadow-orange-500/25'
                        : 'bg-gray-800 group-hover:bg-gray-700 group-hover:scale-105'
                        }`}
                    >
                      <ChevronDown
                        className={`w-4 h-4 transition-colors duration-300 ${openFAQ === index
                          ? 'text-white'
                          : 'text-gray-400 group-hover:text-orange-400'
                          }`}
                      />
